...
module.exports = "../gates.jpg";

/***/ }),
/* 17 */
/***/ (function(module, exports) {

module.exports = "../sins.jpg";

/***/ }),
/* 18 */
/***/ (function(module, exports) {

module.exports = "../lyntik.jpg";

/***/ }),
/* 19 */
/***/ (function(module, exports) {

module.exports = "../Brendan_Eich.jpg";

/***/ }),
/* 20 */
/***/ (function(module, exports) {

module.exports = "../send.png";
...
(function () {
    ...
    var btn = document.querySelector(".right-bar__btn-mobile");
...
(function () {
    var senders = document.querySelectorAll(".left-bar__sender");
    var tabs = document.querySelectorAll(".right-bar__tab");
    var leftBar = document.querySelector(".left-bar");
    var btn = document.querySelector(".right-bar__btn-mobile");
    var inputSearch = document.querySelector(".left-bar__input-find");
    ...
    function showTab(n) {
        ...
        for (var i = 0, max = tabs.length; i < max; i++) {
            ...
            if (senders[i].classList.contains("active-sender") || senders[i].classList.contains("show-sender") || senders[i].classList.contains("hide-sender")) {
        ...
        (function setImg(i) {
            if (tabs.cache[i]) {
                ...
                var mainUserImg = document.querySelector(".active-right-bar  .right-bar__main-user  .right-bar__img-user");
                var secUserImg = document.querySelector(".active-right-bar  .right-bar__second-user  .right-bar__img-user");
                var activeSender = document.querySelector(".active-sender > .left-bar__img");

                mainUserImg.src = "./img/lyntik.jpg";
                var activeSenderSrc = activeSender.src;
                secUserImg.src = activeSenderSrc;
                tabs.cache[i] = true;
            }
        })();

        var input = document.querySelector(".right-bar__input-message");
        input.value = "";
    }
    ...
    leftBar.onclick = function (e) {
        var width = window.innerWidth;
        for (var i = 0, max = senders.length; i < max; i++) {
            var temp = senders[i];
    ...
    function checkChildren(elem, e) {
        for (var i = 0, max = elem.children.length; i < max; i++) {
...
(function () {
    ...
    var btnSend = document.querySelector(".right-bar__send");
    var input = document.querySelector(".right-bar__input-message");
    ...
    function createMsg() {
        ...
        // create div
        var rightBarMain = document.querySelector(".active-right-bar");
        var mainUser = document.createElement("div");
        var message = document.createElement("div");
        var mainUserImg = document.createElement("img");
        var secUser = document.createElement("div");
        var answer = document.createElement("div");
        var secUserImg = document.createElement("img");
        var activeSender = document.querySelector(".active-sender > .left-bar__img");
...
(function () {
    var leftBar = document.querySelector(".left-bar");
    var input = document.querySelector(".left-bar__input-find");
    var senderName = document.querySelectorAll(".left-bar__name");
    var senderDiv = document.querySelectorAll(".left-bar__sender");
    ...
    function clear(value) {
        for (var i = 0, max = senderDiv.length; i < max; i++) {
